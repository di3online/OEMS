...
oems: mainloop.o login.o db.o common.o
	g++ -o oems mainloop.o login.o db.o common.o -g -lpq -lxml2 -L/usr/local/lib
mainloop.o: mainloop.cpp login.h
	g++ -c mainloop.cpp -g -Wall
login.o: login.cpp db.h login.h xml.h common.h
