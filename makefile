...
oems: mainloop.o login.o db.o common.o getGIDByUID.o getUIDByCookie.o handle_lstet.o
	g++ -o oems mainloop.o login.o db.o common.o getGIDByUID.o handle_lstet.o getUIDByCookie.o -g -lpq -lxml2 -L/usr/local/lib
