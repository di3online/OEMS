...
oems: mainloop.o login.o db.o common.o getGIDByUID.o getUIDByCookie.o handle_lstet.o handle_einf.o handle_upans.o
	g++ -o oems mainloop.o login.o db.o common.o getGIDByUID.o handle_lstet.o getUIDByCookie.o handle_einf.o handle_upans.o -g -lpq -lxml2 -L/usr/local/lib
